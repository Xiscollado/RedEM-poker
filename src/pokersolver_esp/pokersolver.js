...
(function() {
    ...
    class StraightFlush extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Escalera de color', game, canDisqualify);
      }
      ...
      solve() {
        ...
        if (this.cards[0] && this.cards[0].rank === 13) {
          this.descr = 'Escalera real';
        } else if (this.cards.length >= this.game.sfQualify) {
          this.descr = this.name + ', ' + this.cards[0].toString().slice(0, -1) + suit + ' Alta';
        }
    ...
    class RoyalFlush extends StraightFlush {
      ...
      solve() {
        ...
        return result && this.descr === 'Escalera real';
      }
    }
    ...
    class FiveOfAKind extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Repoker', game, canDisqualify);
      }
    ...
    class FourOfAKindPairPlus extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Poker y pareja o mejor', game, canDisqualify);
      }
    ...
    class FourOfAKind extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Poker', game, canDisqualify);
      }
    ...
    class ThreeOfAKindTwoPair extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Full', game, canDisqualify);
      }
    ...
    class FullHouse extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Full en mano', game, canDisqualify);
      }
    ...
    class Flush extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Color', game, canDisqualify);
      }
    ...
    class Straight extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Escalera', game, canDisqualify);
      }
    ...
    class TwoThreeOfAKind extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Doble trío', game, canDisqualify);
      }
    ...
    class ThreeOfAKind extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Trío', game, canDisqualify);
      }
    ...
    class ThreePair extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Tres parejas', game, canDisqualify);
      }
    ...
    class TwoPair extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Doble pareja', game, canDisqualify);
      }
    ...
    class OnePair extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Pareja', game, canDisqualify);
      }
    ...
    class HighCard extends Hand {
      constructor(cards, game, canDisqualify) {
        super(cards, 'Carta más alta', game, canDisqualify);
      }
     ...
     * EXCEPTION: With Poker and S/F, preserve the S/F, just like Three of a Kind.
     */
